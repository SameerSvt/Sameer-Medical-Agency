...
function App() {
  ...
  return (
    <>
     ...
     <Navbar searchTerm={searchTerm} setSearchTerm={setSearchTerm} setCategoryTerm={setCategoryTerm}/>
      ...
      <Routes>
        ...
        <Route path="/catalog" element={<Catalog searchTerm={searchTerm} categoryTerm={categoryTerm}/>}/>
